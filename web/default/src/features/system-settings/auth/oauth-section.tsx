...
const buildFormDefaults = (defaults: FlatOAuthDefaults): OAuthFormValues => ({
  ...
  oidc: {
    ...
    required_group: defaults['oidc.required_group'] ?? '',
  },
...
const normalizeFormValues = (values: OAuthFormValues): FlatOAuthDefaults => ({
  ...
  'oidc.required_group': values.oidc.required_group,
          ...
          <SettingsForm onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value='oidc' className={oauthTabContentClassName}>
                ...
                <FormField
                  control={form.control}
                  name='oidc.required_group'
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t('Required Group (Optional)')}</FormLabel>
                      <FormControl>
                        <Input
                          placeholder={t('Group required to sign in')}
                          autoComplete='off'
                          value={field.value ?? ''}
                          onChange={(event) =>
                            field.onChange(event.target.value)
                      ...
                      <FormDescription>
                        {t('If set, only users in this group can sign in')}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
