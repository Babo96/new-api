...
func Init() error {
	...
	initOnce.Do(func() {
		...
		files := []string{"locales/zh-CN.yaml", "locales/zh-TW.yaml", "locales/en.yaml", "locales/de.yaml"}
		...
		localizers[LangDe] = i18n.NewLocalizer(bundle, LangDe)
...
func SupportedLanguages() []string {
	return []string{LangZhCN, LangZhTW, LangEn, LangDe}
}
